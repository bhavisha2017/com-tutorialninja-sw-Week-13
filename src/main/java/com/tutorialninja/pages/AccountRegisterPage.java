...
public class AccountRegisterPage extends Utility {
   ...
   public void clickOnMyAccountLink(){
    ...
    public void typeLastName() {
        sendTextToElement(lastName, "Testing2");
    }
    public void typeEmail() {
        sendTextToElement(email, "prime19670@gmail.com");
    }
    public void typeTelephone(){
        sendTextToElement(telephone,"01547894656");
    }
    public void typePassword() {
        sendTextToElement(password, "Prime1223");
    }
    public void typeConfirmPassword(){
        sendTextToElement(passwordConfirm,"Prime1223");
    }
